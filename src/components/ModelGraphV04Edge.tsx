...
import type { LayoutPoint } from "../domain/modelGraphV04Layouts";

export type ModelGraphV04EdgeData = {
  points?: LayoutPoint[];
  label?: string;
  primary?: boolean;
};

type ModelGraphV04EdgeModel = Edge<ModelGraphV04EdgeData, "routed">;
...
/** Exact V04 full-graph relationship presentation, isolated from the V05 Feature graph edge UI. */
export function ModelGraphV04Edge({
  id,
  sourceX,
  sourceY,
  targetX,
  ...
  style,
  selected
}: EdgeProps<ModelGraphV04EdgeModel>) {
