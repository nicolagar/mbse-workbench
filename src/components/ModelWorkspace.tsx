    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="min-w-0 space-y-4">
          ...
          {effectiveView === "graph" && <section className="card overflow-hidden"><ModelGraph title={tab.graphLabel} subtitle="Select a card, its complete upstream path, or its complete downstream path. Internal relationships within one area remain in Full graph." elements={diagramElements} relationships={diagramRelationships} contextRelationships={diagramContextRelationships} layoutMode={layoutMode} layoutModeOptions={tab.graphLayoutModes} onLayoutModeChange={(mode) => setGraphLayoutMode(activeTab, mode)} layoutKey={`tab:${activeTab}`} scopedElementIds={scopeIds} /></section>}
